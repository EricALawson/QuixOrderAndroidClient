...
public class CheckoutFragment extends Fragment implements Serializable //implements View.OnClickListener
    ...
    {//implements NavigationView.OnNavigationItemSelectedListener {
        ...
        orders = firebase.collection("orders");
        ...
        //pay.setOnClickListener(new View.OnClickListener() {
            v.findViewById(R.id.payBtn).setOnClickListener(/*this);*/new View.OnClickListener() {
                                                               ...
                                                               public void onClick(View view) {
                                                                   ...
                                                                   //(TableActivity)getActivity().payScreen();
                                                                   payCheck();
                                                               }
                                                           });
    ...
    public void payCheck()
    {
      ...
      /*  getSupportActionBar().setTitle("Payment");
        getSupportFragmentManager().beginTransaction().replace(R.id.order_container,
                new Fragment()).commit();
*/
       /* AlertDialog.Builder pay = new AlertDialog.Builder(v.getContext());
        final EditText card = new EditText(v.getContext());
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT);
        ...
        pay.setPositiveButton("Pay", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i)
            {
